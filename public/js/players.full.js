                    ...
                    for (i = 0; i < Data.length; i++) {
                        ...
                        switch (item) {
                            ...
                            case "HouseItems":
                                ...
                                break;
                            case "MoneyLogs":
                                $('#'+item+' > tbody:last-child').append('<tr><td>'+info["Server"]+'</td><td>'+info["Option"]+'</td><td>'+info["toPID"]+'</td><td>'+info["Item"]+'</td><td>'+info["Amount"]+'</td><td>'+info["Price"]+'</td><td>'+moment(info["Time"]).format('YYYY/MM/DD HH:mm:ss')+'</td></tr>');
                                break;
                        }
                    };
                }
